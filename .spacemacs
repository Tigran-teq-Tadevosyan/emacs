...
(defun dotspacemacs/user-config ()
  ;;(split-window-horizontally) ; Adds a window view on the right
  ;;(other-window 1) ; Focuses on the right window
  ;;(shrink-window-horizontally 25) ; Shrinks right window
  (global-set-key [C-return] 'other-window) ; key binding to change to next window with ctrl enter
  (global-set-key [C-M-return] 'neotree-project-dir-toggle)
  (global-set-key [M-return] 'neotree)
  ...
  (neotree-dir "/media/tigran/Common/learning_tests")
